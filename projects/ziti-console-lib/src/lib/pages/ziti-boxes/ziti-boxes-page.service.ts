...
export class ZitiBoxesPageService extends ListPageServiceClass {

    private paging = this.DEFAULT_PAGING;
    public modalType = 'ziti-boxes';
    ...
    selectedZitiBox: any = new Identity();
    columnFilters: any = {
        name: '',
        os: '',
        createdAt: '',
    ...
    override menuItems = [
        {name: 'Download Image', action: 'download-enrollment'},
