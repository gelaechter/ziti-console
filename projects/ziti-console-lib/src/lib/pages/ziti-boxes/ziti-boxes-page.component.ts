...
import {ZitiBoxesPageService} from "./ziti-boxes-page.service";
...
@Component({
  selector: 'lib-ziti-boxes',
  templateUrl: './ziti-boxes-page.component.html',
  styleUrls: ['./ziti-boxes-page.component.scss']
})
export class ZitiBoxesPageComponent extends ListPageComponent implements OnInit, OnDestroy {
  ...
  constructor(
      public override svc: ZitiBoxesPageService,
  ...
  override ngOnInit() {
    this.tabs = this.tabNames.getTabs('zitiboxes');
